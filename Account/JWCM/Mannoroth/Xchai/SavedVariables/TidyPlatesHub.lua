...
TidyPlatesHubSettings = {
	...
	["HubPanelSettingsDamage"] = {
		...
		["WidgetsDebuffPriority"] = {
			["Torment"] = 87,
			["Polymorph"] = 36,
			["Hammer of Justice"] = 41,
			["Hibernate"] = 10,
			["Blind"] = 61,
			["Enslave Demon"] = 69,
			["Psychic Scream"] = 49,
			["Holy Word: Chastise"] = 46,
			["Frost Nova"] = 37,
			["Concussive Shot"] = 28,
			["Freezing Trap"] = 24,
			["Death Grip"] = 6,
			...
			["Ice Trap"] = 27,
			["Hex"] = 63,
			["Demoralizing Shout"] = 80,
			["Banish"] = 67,
			["Cheap Shot"] = 59,
			["Seduction"] = 65,
			["Mass Entanglement"] = 20,
			["Shining Force"] = 47,
			["Wyvern Sting"] = 26,
			["Mind Bomb"] = 50,
			["Gnaw"] = 7,
